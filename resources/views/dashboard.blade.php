                  ...
                  <div class="StakeCard_stake_card__-XwgS">
                     <div class="StakeCard_skymarvel_card__Oq3i3">
                        ...
                        <div class="StakeIncomeCard_skymarvel_inner__14B59 ">
                           ...
                           <div class="StakeIncomeCard_skymarvel_inner_content__r4tea">
                              <p>Total Income</p>
                              <h4 title="0">{{$user->activation_balance}}<span> BBC</span></h4>
                           </div>
                        </div>
                        <div class="StakeIncomeCard_skymarvel_inner__14B59 ">
                           <div class="StakeIncomeCard_skymarvel_inner_img__UX9Ao"><img
                           ...
                           <div class="StakeIncomeCard_skymarvel_inner_content__r4tea">
                              <p>Total Withdraw</p>
                              <h4 title="0">{{$withdraw}}<span> BBC</span></h4>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="StakeCard_skymarvel_card__Oq3i3">
                        <div class="StakeIncomeCard_skymarvel_inner__14B59 ">
                           ...
                           <div class="StakeIncomeCard_skymarvel_inner_content__r4tea">
                              ...
                              <h4 title="0">{{$power_leg_business}}<span> BBC</span></h4>
                           </div>
                        </div>
                        <div class="StakeIncomeCard_skymarvel_inner__14B59 ">
                           <div class="StakeIncomeCard_skymarvel_inner_img__UX9Ao"><img src="data:image/png;base64," alt="icon-bg"></div>
                           <div class="StakeIncomeCard_skymarvel_inner_content__r4tea">
                              ...
                              <h4 title="0">{{$other_team_business}}<span> BBC</span></h4>
                           </div>
                        </div>
                        <div class="StakeIncomeCard_skymarvel_inner__14B59 ">
                           ...
                           <div class="StakeIncomeCard_skymarvel_inner_content__r4tea">
                              ...
                              <h4 title="0">{{$total_leg_business}}<span> BBC</span></h4>
                           </div>
                        </div>
</div>
</br>
